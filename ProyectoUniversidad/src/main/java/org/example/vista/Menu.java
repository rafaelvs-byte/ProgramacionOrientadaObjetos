...
public class Menu {
    ...
    public static void menu() throws IOException {
        int salir = 0;
        while (salir != 7) { // Ahora sale con la opción 7
            System.out.println("\n--- MENÚ PRINCIPAL ---");
            ...
            System.out.println("6. Registrar nuevo profesor"); // Nueva opción única de profesor
            ...
            try {
                ...
                switch (salir) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        registrarProfesor(); // Llama al nuevo método
                        break;
                    case 7:
