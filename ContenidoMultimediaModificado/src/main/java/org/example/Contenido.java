...
public abstract class Contenido {
    ...
    // Corrección: Cambiado de double a int para coincidir con el atributo
    ...
    public void setDuracion(int duracion) {
        if (duracion > 0) {
            ...
            System.out.println("Introduzca una duración válida");
        }
    }
    ...
    public abstract int numeroDeEpisodios();
    public abstract String obtenerDatosGenerales();
